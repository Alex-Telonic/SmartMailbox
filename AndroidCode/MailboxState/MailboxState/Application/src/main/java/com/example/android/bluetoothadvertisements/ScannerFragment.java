...
public class ScannerFragment extends ListFragment {
    ...
    private List<ScanFilter> buildScanFilters() {
        ...
        // Filter for mac
        //builder.setDeviceAddress("DD:33:11:00:0B:B1");
    ...
    private void showNotification(Context context) {
        ...
        Notification notification = new NotificationCompat.Builder(context)
                ...
                .setContentTitle("Briefkasten bitte leeren !")
                .setContentText("Briefkasten ist voll.")
    ...
    private class SampleScanCallback extends ScanCallback {
        ...
        public void onBatchScanResults(List<ScanResult> results) {
            ...
            Log.d(TAG, "Scan Result coming in Batch.");
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            Log.d(TAG, "Scan Result coming in.");

            Log.d(TAG, "RSSI" + String.valueOf(result.getRssi()));


            if (result.getRssi() > - 85) {
                mAdapter.add(result);
